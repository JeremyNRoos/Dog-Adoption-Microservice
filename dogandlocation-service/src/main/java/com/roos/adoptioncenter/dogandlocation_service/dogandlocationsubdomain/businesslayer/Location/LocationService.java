...
public interface LocationService {
    List<LocationResponseModel> getLocations();
    LocationResponseModel getLocationById(String locationId);
    LocationResponseModel addLocation(LocationRequestModel location);
    LocationResponseModel updateLocation(LocationRequestModel location, String locationId);
